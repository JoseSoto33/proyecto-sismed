			...
			<div class="box-header">
				<div class="row">
					<div class="col-xs-12 col-sm-3">
						<a class="btn btn-success" href="<?php echo base_url(); ?>Noticia/AgregarNoticia"><span class="glyphicon glyphicon-plus"></span>Nueva noticia</a>
					</div>
...
<div class="modal fade" id="EliminarNoticia" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
      	<button type="button" id="accion-eliminar-noticia" class="btn btn-primary" data-idnoticia="">Eliminar</button>
