...
<html lang="es">
	<head>
    	...
    	<title>SISMED</title>
    	<link rel="shortcut icon" href="/iut-logo6.ico" type="image/ico" />
		...
		<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/css/style-lab.css">
		<!-- Font Awesome -->
		...
		<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>dist/css/skins/_all-skins.css">
					        ...
					        <ul class="treeview-menu">
					            ...
					            <li>
					            	<a href="<?php echo base_url(); ?>Examenes/AgregarExaHematologia">
					            		<i class="fa fa-circle-o"></i>
										<span>Nuevo Exam. Hematología</span>
					            	</a>
					            </li>
					            <li>
					            	<a href="<?php echo base_url(); ?>Examenes/AgregarExaOrina">
					            		<i class="fa fa-circle-o"></i>
										<span>Nuevo Exam. Orina</span>
					            	</a>
					            </li>
					            <li>
					            	<a href="<?php echo base_url(); ?>Examenes/AgregarExaHeces">
					            		<i class="fa fa-circle-o"></i>
										<span>Nuevo Exam. Heces</span>
					            	</a>
					            </li>
					            <li>
					            	<a href="<?php echo base_url(); ?>Examenes/AgregarExaMixcelaneos">
					            		<i class="fa fa-circle-o"></i>
