...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li>Vacunas</li>
    <li class="active">Agregar nueva vacuna</li>
  </ol>
</section>
		...
		<div class="col-xs-12 col-sm-4">
			<div class="box box-solid box-success">
		        ...
		        <div class="box-body">
					...
					<div id="form-vacuna-instruction" class="form-instructions">
						<div class="col-sm-12">					
							<!-- Descripción -->
		...
		<div class="col-xs-12 col-sm-8">
			<div class="box box-success">
		        ...
		        <div class="box-footer">
					<a href="<?php echo base_url(); ?>Vacuna/ListarVacunas" class="btn btn-default">Cancelar</a>
		        	<button id="guardar" type="submit" form="registro-vacuna" class="btn btn-success pull-right">Guardar</button>
		        </div>
		    </div>
		</div>
	</div>
